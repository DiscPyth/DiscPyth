...
from .struct import is_struct_instance

try:
    from _json import (
        encode_basestring_ascii as c_encode_basestring_ascii,  # type: ignore
    )
except ImportError:
...
try:
    ...
    c_encode_basestring = None  # type: ignore
...
class JSONEncoder:  # pylint: disable=too-many-instance-attributes
    ...
    def encode(self, o) -> str:  # pylint: disable=invalid-name
        ...
        if isinstance(o, str):
            if self.ensure_ascii:  # pylint: disable=no-else-return
                return encode_basestring_ascii(o)
            else:
                return encode_basestring(o)  # type: ignore
...
def _make_iterencode(  # pylint: disable=too-many-arguments, too-many-statements;
    markers,
    _default,
    _encoder,
    _indent,
    ...
    ) -> Iterator[str]:  # pylint: disable=too-many-branches;
        if not lst:
            yield "[]"
            return
