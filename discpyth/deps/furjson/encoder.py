...
def py_encode_basestring(s):  # pylint: disable=invalid-name
...
def py_encode_basestring_ascii(s):  # pylint: disable=invalid-name
...
class JSONEncoder(object):
    ...
    def default(self, o):  # pylint: disable=method-hidden,invalid-name
    ...
    def encode(self, o):  # pylint: disable=invalid-name
        """Return a JSON string representation of a Python data structure.

        >>> from furjson.encoder import JSONEncoder
    ...
    def iterencode(self, o, _one_shot=False):  # pylint: disable=invalid-name
...
def _make_iterencode(  # pylint: disable=invalid-name
    markers,
    _default,
    _encoder,
    _indent,
    ...
    ValueError=ValueError,  # pylint: disable=redefined-builtin,invalid-name
    dict=dict,  # pylint: disable=redefined-builtin
    float=float,  # pylint: disable=redefined-builtin
    id=id,  # pylint: disable=redefined-builtin
    int=int,  # pylint: disable=redefined-builtin
    isinstance=isinstance,  # pylint: disable=redefined-builtin
    list=list,  # pylint: disable=redefined-builtin
    str=str,  # pylint: disable=redefined-builtin
    tuple=tuple,  # pylint: disable=redefined-builtin
    ...
    def _iterencode(o, _current_indent_level):  # pylint: disable=invalid-name
        if isinstance(o, str):
            yield _encoder(o)
        elif o is None:
            yield "null"
