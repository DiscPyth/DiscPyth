...
:mod:`furjson` exposes an API familiar to users of the standard library
...
from .nameddict import NamedDict, NamedDictMeta
...
def dump(  # pylint: disable=invalid-name
    ...
    *,
    ...
    allow_nan: bool = True,
    cls: Optional[Optional[Type[JSONEncoder]]] = None,
...
def detect_encoding(b: bytes) -> str:  # pylint: disable=invalid-name
...
def load(  # pylint: disable=invalid-name
    fp,
    *,
    obj: Union[NamedDict, NamedDictMeta] = None,
...
def loads(  # pylint: disable=invalid-name
    ...
    **kw: Any,
    ...
    if (
        ...
        return _default_decoder.decode(s, obj=obj)
    if cls is None:
        cls = JSONDecoder
    ...
    return cls(**kw).decode(s, obj=obj)
